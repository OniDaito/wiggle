...
imagine::ImageF32L3D ProcessPipe(imagine::ImageU16L3D const &image_in,  ROI &roi, bool autoback, float noise, bool deconv, const std::string &psf_path, int deconv_rounds);
